...
Route::group(['prefix' => '/v1', 'middleware' => ['audit.log']], function () {
    ...
    Route::post('deeplink-redirect', 'API\V1\DeeplinkRedirectionController@getRedirectionLink');
    ...
    Route::get('recycle-msisdn-check', 'API\V1\RecycleMsisdnController@recycleMsisdnCheck');
