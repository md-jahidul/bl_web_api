    ...
    public function getAboutusPages($url_slug)
    {
        try {
            ...
            $formatted_data = [
                ...
                'banner_image'            => env('IMAGE_HOST_URL') . $data->banner_image ?? null,
                'banner_image_mobile'     => env('IMAGE_HOST_URL') . $data->banner_image_mobile ?? null,
                ...
                'content_image'           => env('IMAGE_HOST_URL') . $data->content_image ?? null
            ];
            $data = $formatted_data;
