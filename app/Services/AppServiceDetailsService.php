            ...
            foreach ($results as $value) {
                ...
                if (!empty($value->detailsComponent) && count($value->detailsComponent) > 0) {
                    ...
                    foreach ($value->detailsComponent as $item) {
                        ...
                        $sub_item['image_url_en'] = isset($fileViewer["image_url_en"]) ? $fileViewer["image_url_en"] : null;
                        $sub_item['image_url_bn'] = isset($fileViewer['image_url_bn']) ? $fileViewer['image_url_bn'] : null;
                        $sub_item['alt_text'] = $item->alt_text;
                        $sub_item['alt_text_bn'] = $item->alt_text_bn;
