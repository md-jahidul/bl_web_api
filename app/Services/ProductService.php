...
//                return response()->success($viewAbleProducts, 'Data Found!');
    ...
    public function details($slug)
    {
        try {
            ...
            $productDetail->product_details->banner_image_web_en = isset($imgData['banner_image_web_en']) ? $imgData['banner_image_web_en'] : '/uploads/' . $productDetail->banner_image_url;
            $productDetail->product_details->banner_image_web_bn = isset($imgData['banner_image_web_bn']) ? $imgData['banner_image_web_bn'] : '/uploads/' . $productDetail->banner_image_url;
            $productDetail->product_details->banner_image_mobile_en = isset($imgData['banner_image_mobile_en']) ? $imgData['banner_image_mobile_en'] : '/uploads/' . $productDetail->banner_image_mobile;
            $productDetail->product_details->banner_image_mobile_bn = isset($imgData['banner_image_mobile_bn']) ? $imgData['banner_image_mobile_bn'] : '/uploads/' . $productDetail->banner_image_mobile;
