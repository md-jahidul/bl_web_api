...
use App\Services\Payment\OwnChannelPaymentService;

class OwnChannelPaymentController extends Controller
{

    protected $base_url = '';
    /**
     * @var OwnChannelPaymentService
     */
    private $ownChannelPaymentService;

    public function __construct(OwnChannelPaymentService $ownChannelPaymentService)
    {
        $this->base_url = url('/') . '/api/v1'; // 'http://localhost:3030';
        $this->ownChannelPaymentService = $ownChannelPaymentService;
    }

    public function paymentGateways()
    {
        return $this->ownChannelPaymentService->paymentGateways();
    }
